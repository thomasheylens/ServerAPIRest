...
public class MethodesController {
	...
	public ArrayList<VilleFrance> get(@RequestParam(required = false, value="codeCommuneINSEE") String codeCommuneINSEE,
		...
		villes = villeFranceDAO.trouver(ville.map(codeCommuneINSEE, nomCommune, codePostal, 
												libelleAcheminement, ligne5, latitude, longitude));
	...
	@ResponseBody
	public void delete(@RequestParam(required = true, value="codeCommuneINSEE") String codeCommuneINSEE) throws SQLException {
